...
public class PongBall {
	...
	int horizontalPosition; // horizontal  position of the ball
	int verticalPosition; // vertical position of the ball
	int horizontalSpeed; 
	int verticalSpeed;
    ...
    public PongBall(int initHorizPos, int initVertPos, 
    	...
    	horizontalPosition = initHorizPos;
    	verticalPosition = initVertPos;
    	horizontalSpeed = initHorizSpeed;
    	verticalSpeed = initVertSpeed;
    ...
    public void horizBounce() {
        // Add your code here.
    	horizontalSpeed = -horizontalSpeed; //Zimeng
    }
    ...
    public void vertBounce() {
    	verticalSpeed = -verticalSpeed; //Zimeng
        // Add your code here.
    }
